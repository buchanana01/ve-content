...
- `ACTION`is the specific action to be performed by the component.  The actions supported by a component are defined in
...
1. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY5MjkwNTkxNywtNTA1NjA5ODQwLDEwNT
