...
- `TARGET` is the visualization component that should perform the action.  The value is the portion of the component tag without the `ve-` prefix.  For instance, if the action is intended for a `ve-map` component the value 
...
1. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3Mjk4NzcwODAsLTUwNTYwOTg0MCwxMD
