...
- __time-dimension__:  Set to `true` to enable the time dimension controls.  When enabling the time dimension the input data is expected to 
...
1. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNzY3MzU5NDMsMTA1NjU3NzQ5OCwtOT
