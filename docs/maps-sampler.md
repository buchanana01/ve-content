...
<param ve-image 
       url="https://upload.wikimedia.org/wikipedia/commons/9/9e/Babylonian_Map_of_the_World%2C_700-500_BC.jpg"
...
<param ve-map
       ...
       fill="blue" 
       fill-opacity="1">
<param ve-map-layer title="Worlds most populated cities" url="/geojson/cities.json">
...
<param ve-map 
       ...
       date-format="YYYY"
       fps="4">
<param ve-map-layer title="US States" url="/geojson/us-states.json">
<param ve-map-layer title="Great Lakes Fruit Belt" url="/geojson/great-lakes-fruit-belt.json">
